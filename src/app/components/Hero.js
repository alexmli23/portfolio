...
export default function Hero({ fadeOpacity, blurEffect, scaleEffect }) {
  return (
    <div className="relative w-full min-h-screen overflow-hidden font-serif">
      ...
      >
        <h1 className="text-3xl sm:text-4xl md:text-7xl font-bold tracking-tight">
          Hi 👋
        </h1>

        <h1 className="text-5xl sm:text-4xl md:text-7xl font-bold tracking-tight">
            I'm Alex!
        </h1>

        <p className="mt-4 text-base sm:text-lg md:text-2xl text-white">
        ...
        <p className="mt-4 sm:mt-4 text-xs sm:text-sm tracking-wide text-white">
          Paris — 2026
        </p>
      </motion.div>
